...
const MustElectricalEngineering =({electricalEngineering,input, setInput}) => {
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>MUST Electrical Engineering Projects</Text>
</TouchableOpacity>
...
export default MustElectricalEngineering;
