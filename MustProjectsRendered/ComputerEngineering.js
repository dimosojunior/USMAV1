...
const MustComputerEngineering =({computerEngineeringProjects,input, setInput}) => {
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>MUST Computer Engineering Projects</Text>
</TouchableOpacity>
...
export default MustComputerEngineering;
