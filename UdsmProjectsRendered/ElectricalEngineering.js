...
const UdsmElectricalEngineering =({electricalEngineering, input, setInput}) => {
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>UDSM Electrical Engineering Projects</Text>
</TouchableOpacity>
...
export default UdsmElectricalEngineering;
