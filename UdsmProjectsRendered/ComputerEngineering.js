...
const UdsmComputerEngineering =({computerEngineeringProjects, input, setInput}) => {
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>UDSM Computer Engineering Projects</Text>
</TouchableOpacity>
...
export default UdsmComputerEngineering;
