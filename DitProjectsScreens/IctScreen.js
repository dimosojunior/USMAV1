...
import DitICT from '../DitProjectsRendered/Ict';
...
export default function DitIctProjects({ navigation  }) {
...
const { universities:ict, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/DitICTAllProjects/');
...
{/*<DitICT ict={ict.filter(
  (item) => item.CourseName === 'ICT' && item.university === 'DIT' ) } 
...
<DitICT ict={ict} input={input} setInput={setInput} />
