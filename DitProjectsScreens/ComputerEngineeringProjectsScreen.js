...
import DitComputerEngineering from '../DitProjectsRendered/ComputerEngineering';
...
export default function DitComputerEngineeringProjects({ navigation  }) {
...
// kwa ajili ya individuals projects zote za kozi mbalimbali
 ...
 //  {
 //    ProjectName:'Wheel Chair for Disabled People',
 //    university:'DIT',
 //    ProjectImage:require('../assets/2q.jpeg'),
 ...
 //    ProjectBody: 'Examination cheating activities like face movement head movements, hand movements, or hand contact are extensively involved, and the rectitude and worthiness of fair and unbiased examination are prohibited by such cheating activities. The aim of this project is to develop a model to supervise or control unethical activities in real-time examinations. Exam supervision is fallible due to limited human abilities and capacity to handle students in examination rooms, and these errors can be reduced with the help of the Smart Invigilation System Examination cheating activities like face movement head movements, hand movements, or hand contact are extensively involved, and the rectitude and worthiness of fair and unbiased examination are prohibited by such cheating activities. The aim of this project is to develop a model to supervise or control unethical activities in real-time examinations. Exam supervision is fallible due to limited human abilities and capacity to handle students in examination rooms, and these errors can be reduced with the help of the Smart Invigilation System',
...
const { universities:computerEngineeringProjects, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/DitComputerEngineeringAllProjects/');
...
{/*<DitComputerEngineering computerEngineeringProjects={computerEngineeringProjects.filter(
  (item) => item.CourseName === 'Computer Engineering' && item.university === 'DIT' ) } 
...
<DitComputerEngineering computerEngineeringProjects={computerEngineeringProjects} input={input} setInput={setInput} />
