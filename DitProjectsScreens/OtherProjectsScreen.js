...
import DitOtherProjects from '../DitProjectsRendered/OtherProjects';
...
export default function DitOtherProjectsScreen({ navigation  }) {
...
const { universities:otherProjects, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/DitOtherProjectsAllProjects/');
...
{/*<DitOtherProjects otherProjects={otherProjects.filter(
  (item) => item.CourseName === 'Other Projects' && item.university === 'DIT' ) } 
...
<DitOtherProjects otherProjects={otherProjects} input={input} setInput={setInput} />
