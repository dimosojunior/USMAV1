...
import DitElectricalEngineering from '../DitProjectsRendered/ElectricalEngineering';
...
export default function DitElectricalEngineeringProjects({ navigation  }) {
...
const { universities:electricalEngineering, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/DitElectricalEngineeringAllProjects/');
...
{/*<DitElectricalEngineering electricalEngineering={electricalEngineering.filter(
  (item) => item.CourseName === 'Electrical Engineering' && item.university === 'DIT' )} 
...
<DitElectricalEngineering electricalEngineering={electricalEngineering} input={input} setInput={setInput} />
