...
const [darkMode, setdarkMode] = useState(false)
 ...
 //FOR UNIVERSITY APIS
//const { universities, isPending, error } = useFetch('https://a2ca-196-249-104-119.ngrok-free.app/apis/Universities');
...
// FOR ARTICLES
 const [articles, setArticles] = useState([
  {
    ...
    Github:'Dodoma ',
    ArticleImage:require('../assets/udom.jpg'),
...

  {
    ...
    ArticleImage:require('../assets/udsm.jpeg'),  
    ArticleBody:'AI Articles',
    ShortDescription:'My Article',
    WrittenBy:'Junior',
    id:'2'
...

  {
    ...
    Github:'Morogoro',
    ArticleImage:require('../assets/must.jpg'), 
    ArticleBody:'AI Articles',
    ShortDescription:'My Article',
    WrittenBy:'Zack',
    id:'3'
 ...
 //FOR ARTICLES APIS
//const { universities:articles, isPending, error } = useFetch('https://a2ca-196-249-104-119.ngrok-free.app/apis/Universities');
