...
const UdomElectricalEngineering =({electricalEngineering,input, setInput}) => {
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>UDOM Electrical Engineering Projects</Text>
</TouchableOpacity>
...
export default UdomElectricalEngineering;
