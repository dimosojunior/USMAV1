...
const UdomOtherProjects =({otherProjects,input, setInput}) => {
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>Other Projects</Text>
</TouchableOpacity>
...
export default UdomOtherProjects;
