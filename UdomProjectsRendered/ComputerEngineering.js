...
const UdomComputerEngineering =({computerEngineeringProjects,input, setInput}) => {
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>UDOM Computer Engineering Projects</Text>
</TouchableOpacity>
...
export default UdomComputerEngineering;
