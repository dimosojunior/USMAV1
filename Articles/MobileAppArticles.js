...
const renderersProps ={
 ...
 // const [mobileAppArticles, setMobileAppArticles] = useState([
 //  {
 //    Title:'How to Start lerning Mobile App',
 //    Github:'Dodoma ',
 //    ArticleImage:require('../assets/1q.jpeg'),
 //    ArticleBody:'Mobile App Articles',
 ...
 //FOR ARTICLES APIS
const { universities:mobileAppArticles, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/MobileApplicationsArticles');
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>MOBILE APPLICATIONS ARTICLES</Text>
</TouchableOpacity>
