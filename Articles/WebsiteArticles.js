...
const renderersProps ={
 ...
 // FOR WEBSITES ARTICLES
 // const [websiteArticles, setWebsite] = useState([
 //  {
 //    Title:'How to Start lerning Website',
 //    Github:'Dodoma ',
 //    ArticleImage:require('../assets/1q.jpeg'),
 //    ArticleBody:'Website Articles',
 ...
 //FOR WEBSITES ARTICLES APIS
const { universities:websiteArticles, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/WebsiteArticles');
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>WEBSITE ARTICLES</Text>
</TouchableOpacity>
