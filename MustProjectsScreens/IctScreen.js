...
import MustICT from '../MustProjectsRendered/Ict';
...
export default function MustIctProjects({ navigation  }) {
...
// kwa ajili ya individuals projects zote za kozi mbalimbali
 ...
 //   {
 //    ProjectName:'Speed Control Manufacturing',
...
const { universities:ict, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/MustICTAllProjects/');
...
{/*<MustICT ict={ict.filter(
  (item) => item.CourseName === 'ICT' && item.university === 'Mbeya University' ) } 
...
<MustICT ict={ict} input={input} setInput={setInput} />
)}
