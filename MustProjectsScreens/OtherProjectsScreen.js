...
import MustOtherProjects from '../MustProjectsRendered/OtherProjects';
...
export default function MustOtherProjectsScreen({ navigation  }) {
...
const { universities:otherProjects, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/MustOtherProjectsAllProjects/');
...
{/*<MustOtherProjects otherProjects={otherProjects.filter(
  (item) => item.CourseName === 'Other Projects' && item.university === 'Mbeya University' ) } 
...
<MustOtherProjects otherProjects={otherProjects} input={input} setInput={setInput} />
