...
import MustComputerEngineering from '../MustProjectsRendered/ComputerEngineering';
...
export default function MustComputerEngineeringProjects({ navigation  }) {
...
// kwa ajili ya individuals projects zote za kozi mbalimbali
 ...
 //  {
 //    ProjectName:'Wheel Chair for Disabled',
...
const { universities:computerEngineeringProjects, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/MustComputerEngineeringAllProjects/');
...
{/*<MustComputerEngineering computerEngineeringProjects={computerEngineeringProjects.filter(
  (item) => item.CourseName === 'Computer Engineering' && item.university === 'Mbeya University' ) } 
...
<MustComputerEngineering computerEngineeringProjects={computerEngineeringProjects} input={input} setInput={setInput} />
