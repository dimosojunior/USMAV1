...
const DitElectricalEngineering =({electricalEngineering,input, setInput}) => {
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>DIT Electrical Engineering Projects</Text>
</TouchableOpacity>
...
export default DitElectricalEngineering;
