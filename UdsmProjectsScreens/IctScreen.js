...
import UdsmICT from '../UdsmProjectsRendered/Ict';
...
export default function UdsmIctProjects({ navigation  }) {
...
const { universities:ict, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/UdsmICTAllProjects/');
...
{/*<UdsmICT ict={ict.filter(
  (item) => item.CourseName === 'ICT' && item.university === 'University of Dar es salaam' ) }
...
<UdsmICT ict={ict} input={input} setInput={setInput} />
