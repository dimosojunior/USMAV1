...
import UdsmOtherProjects from '../UdsmProjectsRendered/OtherProjects';
...
export default function UdsmOtherProjectsScreen({ navigation  }) {
...
// kwa ajili ya individuals projects zote za kozi mbalimbali
 ...
 //   {
 //    ProjectName:'Water Reusing System',
 //    university:'University of Dar es salaam',
...
const { universities:otherProjects, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/UdsmOtherProjectsAllProjects/');
...
{/*<UdsmOtherProjects otherProjects={otherProjects.filter(
  (item) => item.CourseName === 'Other Projects' && item.university === 'University of Dar es salaam' ) } 
...
<UdsmOtherProjects otherProjects={otherProjects} input={input} setInput={setInput} />
