...
import UdsmElectricalEngineering from '../UdsmProjectsRendered/ElectricalEngineering';
...
export default function UdsmElectricalEngineeringProjects({ navigation  }) {
...
const { universities:electricalEngineering, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/UdsmElectricalEngineeringAllProjects/');
...
{/*<UdsmElectricalEngineering electricalEngineering={electricalEngineering.filter(
  (item) => item.CourseName === 'Electrical Engineering' && item.university === 'University of Dar es salaam' )} 
...
<UdsmElectricalEngineering electricalEngineering={electricalEngineering} input={input} setInput={setInput} />
)}
