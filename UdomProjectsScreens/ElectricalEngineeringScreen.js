...
// import ComputerEngineering from '../ProjectsRendered/ComputerEngineering';
// import ICT from '../ProjectsRendered/Ict';
import UdomElectricalEngineering from '../UdomProjectsRendered/ElectricalEngineering';
...
export default function UdomElectricalEngineeringProjects({ navigation  }) {
...
const { universities:electricalEngineering, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/UdomElectricalEngineeringAllProjects');
...
<UdomElectricalEngineering electricalEngineering={electricalEngineering.filter(
  (item) => item.CourseName === 'Electrical Engineering' && item.university === 'University of Dodoma' )} 
...
<UdomElectricalEngineering electricalEngineering={electricalEngineering} input={input} setInput={setInput}/>
)}
