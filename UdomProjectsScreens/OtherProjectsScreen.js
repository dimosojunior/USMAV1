...
import UdomOtherProjects from '../UdomProjectsRendered/OtherProjects';
...
export default function UdomOtherProjectsScreen({ navigation  }) {
...
const { universities:otherProjects, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/UdomOtherProjectsAllProjects/');
...
{/*
<UdomOtherProjects otherProjects={otherProjects.filter(
  (item) => item.CourseName === 'Other Projects' && item.university === 'University of Dodoma' ) } 
...
<UdomOtherProjects otherProjects={otherProjects} input={input} setInput={setInput} />
