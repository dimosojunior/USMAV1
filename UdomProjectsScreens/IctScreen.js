...
import UdomICT from '../UdomProjectsRendered/Ict';
...
export default function UdomIctProjects({ navigation  }) {
...
const { universities:ict, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/UdomICTAllProjects/');
...
{/*<UdomICT ict={ict.filter(
  (item) => item.CourseName === 'ICT' && item.university === 'University of Dodoma' ) } 
...
<UdomICT ict={ict} input={input} setInput={setInput}/>
