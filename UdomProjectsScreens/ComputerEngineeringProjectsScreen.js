...
import UdomComputerEngineering from '../UdomProjectsRendered/ComputerEngineering';
...
export default function UdomComputerEngineeringProjects({ navigation  }) {
...
const { universities:computerEngineeringProjects, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/UdomComputerEngineeringAllProjects/');
...
{/*<UdomComputerEngineering computerEngineeringProjects={computerEngineeringProjects.filter(
  (item) => item.CourseName === 'Computer Engineering' && item.university === 'University of Dodoma' ) } 
...
<UdomComputerEngineering computerEngineeringProjects={computerEngineeringProjects} input={input} setInput={setInput} />
