...
const [CourseName, setCourseName] = useState('');
    const move = (CourseName) =>{
      ...
      navigation.navigate('Udom ' +CourseName);
    }
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>UDOM COURSES</Text>
</TouchableOpacity>
