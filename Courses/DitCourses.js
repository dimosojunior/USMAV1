...
const [CourseName, setCourseName] = useState('');
    const move = (CourseName) =>{
      ...
      navigation.navigate('Dit ' +CourseName);
    }
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>DIT Courses</Text>
</TouchableOpacity>
