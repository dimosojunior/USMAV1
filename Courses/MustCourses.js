...
const [CourseName, setCourseName] = useState('');
    const move = (CourseName) =>{
      ...
      navigation.navigate('Must ' +CourseName);
    }
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>Mbeya University Courses</Text>
</TouchableOpacity>
