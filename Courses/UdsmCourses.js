...
// HII NI FUNCTION YAKUNAVIGATE KWENDA KWENYE PROJECTS ZA KOZI  HUSIKA
const [CourseName, setCourseName] = useState('');
    const move = (CourseName) =>{
      setCourseName(CourseName);
      console.log(CourseName)
      navigation.navigate('Udsm ' +CourseName);
    }
//INAISHIA HAPA HII NI FUNCTION YAKUNAVIGATE KWENDA PROJECTS ZA KWENYE KOZI CHUO HUSIKA
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>University of Dar es salaam Courses</Text>
</TouchableOpacity>
