...
import UdsmCourses from '../Courses/UdsmCourses';
...
export default function Udsm({navigation  }) {
...
//  const [udsmCourses, setUdsmCourses] = useState([
...
// {CourseName:'ICT',University:'University of Dar es salaam',CourseImage:require('../assets/must.jpg'),id:'2'},
// {CourseName:'Other Projects',University:'University of Dar es salaam',CourseImage:require('../assets/3q.jpeg'),id:'2'},
...
const { universities:udsmCourses, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/UdsmUniversityCourses');
...
{/*<UdsmCourses udsmCourses={udsmCourses.filter((item) => item.University === 'University of Dar es salaam') } />
*/}
...
<UdsmCourses udsmCourses={udsmCourses} />
