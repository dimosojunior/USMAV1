...
const ComputerMaintenanceExperts =({navigation }) => {
...
const renderersProps ={
 ...
 // FOR ComputerMaintenanceExperts

 // const [computerMaintenanceExperts, setComputerMaintenanceExperts] = useState([
 //  {
 //    StudentName:'Shukuru Dimoso',
 //    CategoryName:'Computer Maintenance Experts',
 //    Github:'Dodoma ',
 ...
 //    ShortDescription:'ComputerMaintenanceExperts Articles',
 ...
 //    Body:'ComputerMaintenanceExperts Articles',
 //    ShortDescription:'My ComputerMaintenanceExperts',
 //    WrittenBy:'Junior',
 //    id:'2'
 //  },
 ...
 //FOR ComputerMaintenanceExperts APIS
const { universities:computerMaintenanceExperts, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/ComputerMaintenanceExperts');
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>COMPUTER MAINTENANCE EXPERT</Text>
</TouchableOpacity>
 ...
 { isPending ? (
        ...
        <View style={{
          ...
          <Animated.FlatList
            data={computerMaintenanceExperts}
...
export default ComputerMaintenanceExperts;
