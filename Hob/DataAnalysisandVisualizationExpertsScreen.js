...
const DataAnalysisandVisualizationExperts =({navigation }) => {
...
const renderersProps ={
 ...
 // FOR DataAnalysisandVisualizationExperts


 // const [dataAnalysisandVisualizationExperts, setDataAnalysisandVisualizationExperts] = useState([
 //  {
 //    StudentName:'Shukuru Dimoso',
 //    CategoryName:'Data Analysis and Visualization Experts',
 //    Github:'Dodoma ',
 ...
 //    ShortDescription:'DataAnalysisandVisualizationExperts Articles',
 ...
 //    Body:'DataAnalysisandVisualizationExperts Articles',
 //    ShortDescription:'My DataAnalysisandVisualizationExperts',
 //    WrittenBy:'Junior',
 //    id:'2'
 //  },
 ...
 //FOR DataAnalysisandVisualizationExperts APIS
const { universities:dataAnalysisandVisualizationExperts, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/DataAnalysisandVisualizationExperts');
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>Data Analysis and Visualization Experts</Text>
</TouchableOpacity>
      ...
      { isPending ? (
        ...
        <View style={{
          ...
          <Animated.FlatList
            data={dataAnalysisandVisualizationExperts}
...
export default DataAnalysisandVisualizationExperts;
