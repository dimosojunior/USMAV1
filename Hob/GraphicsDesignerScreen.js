...
const GraphicsDesigner =({navigation }) => {
...
const renderersProps ={
 ...
 // const [graphicsDesignerExperts, setGraphicsDesignerExperts] = useState([
 //  {
 ...
 //    ShortDescription:'graphicsDesignerExperts Articles',
 ...
 //    Body:'graphicsDesignerExperts Articles',
 //    ShortDescription:'My graphicsDesignerExperts',
 //    WrittenBy:'Junior',
 //    id:'2'
 //  },
 ...
 //FOR graphicsDesignerExperts APIS
const { universities:graphicsDesignerExperts, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/GraphicsDesignerExperts');
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>GRAPHICS DESIGNER EXPERTS</Text>
</TouchableOpacity>
