...
const AutomationExperts =({navigation }) => {
...
const renderersProps ={
 ...
 // FOR AutomationExperts


 // const [automationExperts, setAutomationExperts] = useState([
 //  {
 //    StudentName:'Shukuru Dimoso',
 //    CategoryName:'Automation Experts',
 //    Github:'Dodoma ',
 ...
 //    ShortDescription:'AutomationExperts Articles',
 ...
 //    Body:'AutomationExperts Articles',
 //    ShortDescription:'My AutomationExperts',
 //    WrittenBy:'Junior',
 //    id:'2'
 //  },
 ...
 //FOR AutomationExperts APIS
const { universities:automationExperts, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/AutomationExperts');
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>AUTOMATION EXPERTS</Text>
</TouchableOpacity>
...
export default AutomationExperts;
