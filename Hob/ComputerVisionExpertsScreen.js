...
const ComputerVisionExperts =({navigation }) => {
...
const renderersProps ={
 ...
 // FOR graphicsDesignerExperts


 // const [computerVisionExperts, setComputerVisionExperts] = useState([
 //  {
 //    StudentName:'Shukuru Dimoso',
 //    CategoryName:'Computer Vision Experts',
 //    Github:'Dodoma ',
 ...
 //    ShortDescription:'ComputerVisionExperts Articles',
 ...
 //    Body:'ComputerVisionExperts Articles',
 //    ShortDescription:'My ComputerVisionExperts',
 //    WrittenBy:'Junior',
 //    id:'2'
 //  },
 ...
 //FOR ComputerVisionExperts APIS
const { universities:computerVisionExperts, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/ComputerVisionExperts');
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>COMPUTER VISION EXPERTS</Text>
</TouchableOpacity>
...
export default ComputerVisionExperts;
