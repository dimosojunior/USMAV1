...
const MobileApplicationsDevelopers =({navigation }) => {
...
const renderersProps ={
 ...
 // FOR MobileApplicationsDevelopers

 // const [mobileApplicationsDevelopers, setMobileApplicationsDevelopers] = useState([
 //  {
 //    StudentName:'Shukuru Dimoso',
 //    CategoryName:'Mobile Applications Developers',
 //    Github:'Dodoma ',
 ...
 //    ShortDescription:'MobileApplicationsDevelopers Articles',
 ...
 //    Body:'MobileApplicationsDevelopers Articles',
 //    ShortDescription:'My MobileApplicationsDevelopers',
 //    WrittenBy:'Junior',
 //    id:'2'
 //  },
 ...
 //FOR mobileApplicationsDevelopers APIS
const { universities:mobileApplicationsDevelopers, isPending, error } = useFetch('https://freeprojectsshareapp.pythonanywhere.com/apis/MobileApplicationsExperts');
...
<TouchableOpacity>
<Text style={[globalstyles.universityheadertext,{color:theme.color}]}>Mobile Applications Developers</Text>
</TouchableOpacity>
 ...
 { isPending ? (
        ...
        <View style={{
          ...
          <Animated.FlatList
            data={mobileApplicationsDevelopers}
...
export default MobileApplicationsDevelopers;
